...
if (!post) {
  ...
  if (isGallery) return <GalleryClient post={post} templateId={templateId} tagPrefix={tagPrefix} />;
  if (isLiveBlog) return <LiveBlogViewer post={post} tagPrefix={tagPrefix} templateId={templateId} />;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <aside className="lg:col-span-4 lg:sticky lg:top-0 space-y-8">
              <SidebarDeferredClient
                currentPostId={String(post?.slug || post?._id || '') || undefined}
                categorySlug={(() => {
                ...
                authorId={(() => {
                  const candidate = primaryAuthor || post.author || null;
